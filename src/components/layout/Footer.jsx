        ...
        <div className="footer-section brand-section">
          ...
          <div className="social-media">
            ...
            <div className="social-links">
              <a 
                href="https://www.facebook.com/share/17EGYVN7VS/?mibextid=wwXIfr" 
                target="_blank" 
              ...
              <a 
                href="https://www.instagram.com/lamegatienda_gt?igsh=MWhsbTBrbG9hOHozbA==" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://www.tiktok.com/@lamegatiendagt?_t=ZM-8z4itWJ8BoD&_r=1" 
                target="_blank" 
                rel="noopener noreferrer"
        ...
        <div className="footer-section">
          ...
          <div className="contact-info">
            ...
            <div className="contact-item">
              ...
              <span>Km 28 Ruta al Pacífico, Parque Industrial Distripark, Bodega A04</span>
            </div>
